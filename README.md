...
```bash
# macOS / Linux
curl -fsSL https://raw.githubusercontent.com/tyvhb/SiftStack/main/install.py | python3 -

# Windows PowerShell
irm https://raw.githubusercontent.com/tyvhb/SiftStack/main/install.py | python -
```
...
```bash
curl -fsSL -o install.py https://raw.githubusercontent.com/tyvhb/SiftStack/main/install.py
less install.py
python3 install.py
```
...
```
https://raw.githubusercontent.com/tyvhb/SiftStack/main/dist/rehab-estimator.skill
```
...
> Read https://raw.githubusercontent.com/tyvhb/SiftStack/main/skills/manifest.json and install the Deal Analysis skills for me.
...
```bash
git clone https://github.com/tyvhb/SiftStack.git
cd SiftStack
