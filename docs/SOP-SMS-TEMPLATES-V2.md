# SOP — SMS Templates V2 (Sales-Psychology-Driven)

**Audience:** Mike — daily text outreach.
**Purpose:** SMS templates rebuilt around proven distress-real-estate sales psychology. Every message uses one or more of these techniques: pattern interrupt, curiosity gap, validation, reciprocity, social proof, future pacing, take-away close. Tested against the way these specific homeowners actually feel.

This supersedes [SOP-SMS-TEMPLATES-BY-PRESET.md](SOP-SMS-TEMPLATES-BY-PRESET.md). Use V2 for all new outreach.

---

## Why these convert better than the V1 templates

V1 was too wholesale-y: introduce yourself → say what you do → ask if interested. That's the same script every other investor uses — they delete on autopilot.

V2 leads with **the homeowner's emotional reality first**. Every Day 1 opens by validating what they're going through, not announcing what we want. The pitch is the second message, not the first.
...
## What's different per stage of distress

**LIS PENDENS** (just got served, heart racing): Reframe panic into agency. "You have time. You have options most people don't know."

**SHERIFF SALE** (deadline pressure): Don't add urgency — they're already feeling it. Validate their stress, then offer calm.

**PROBATE** (grief + admin overload): Don't pitch. Offer presence. Honor their timeline.

**REDEMPTION WINDOW** (despair + last chance): Hope angle. "Wait — most people don't know this still works."

---

## Variables you'll substitute

Same as V1: `{{first}}`, `{{address}}`, `{{auction}}`, `{{decedent}}`, `{{relationship}}`, `{{me}}`, `{{phone}}`. Make sure your DataSift bulk-SMS column mapping is set before sending.

---

# 1. Lis Pendens — Montgomery (Dayton)

**Their reality:** Got served papers in the last few weeks. Heart racing. Probably haven't told family yet. Already googled "what happens after foreclosure filing" 30 times.

**Our hook:** Validation + curiosity ("you have more time than you think")
...
# 2. Lis Pendens — Franklin (Columbus)

**Their reality:** Same as Mont but Columbus market — higher home values, more equity at stake, more skeptical of investors (more competition in market).

**Our hook:** Equity protection angle (they have more to lose than they realize)
...
# 3. Lis Pendens — Greene (Xenia)

**Their reality:** Smaller community. Word travels. Probably knows someone else this happened to. Skeptical of out-of-towners.

**Our hook:** Hometown trust + neighborly tone
...
# 4. Sheriff Sale — Montgomery (Dayton)

**Their reality:** Sale on the calendar. Either resigned ("it's over") or scrambling ("how do I stop this"). Probably gotten 30+ calls/texts from other buyers this week.

**Our hook:** Acknowledge the noise, then differentiate
...
# 5. Sheriff Sale — Franklin (Columbus)

**Their reality:** Higher property value = more skeptical they need help. May be in active negotiation with bank. May have refinanced/heloc'd recently.

**Our hook:** Sophistication match + track record
...
# 6. Sheriff Sale — Greene (Xenia)

**Their reality:** Greene SS volume is low — usually means the deal is more visible to fewer competitors. Owner may not have gotten as many calls.

**Our hook:** Personal + simple
...
# 7. Probate — Montgomery (Dayton)

**Their reality:** They're the executor. Their family member just died. They're tired, sad, dealing with 50 admin tasks, getting calls from creditors. The LAST thing they want is a wholesaler pitch.

**Our hook:** Presence over pitch. We do the OPPOSITE of what every other wholesaler does on Day 1 — we DON'T ask for anything.
...
# 8. Probate — Franklin (Columbus)

**Their reality:** Highest volume county. Likely have multiple heirs in the picture. May be navigating sibling dynamics. Property might be Mom/Dad's house = high emotional weight.

**Our hook:** Multi-heir aware + dignity-preserving
...
# 9. Probate — Greene (Xenia)

**Their reality:** Small community, may know other people who went through this. Property might be a generational family home.

**Our hook:** Honor the property's history + local roots
...
**Their reality:** They feel they've already lost. Sheriff sale already happened. Probably depressed, embarrassed, told family it's over. **Most don't realize redemption rights exist.**

**Our hook:** Hope angle + education. "Wait — most people don't know this still works."
...
## Response handlers — what to text back when they reply

These are just as important as the openers. Most wholesalers fumble the response.
...
DataSift auto-tags. Never re-text. `do_not_contact` permanently.

### They reply with a question (any other)

Answer it directly. Don't pivot to a pitch. They're testing whether we're a real human.
...
Track per variant:
- Reply rate (any response, even STOP)
- Positive reply rate (interested + question, NOT not-interested or STOP)
- Conversion to call/appointment
- Conversion to deal closed

After 100 records per variant, **standardize on the highest converter** — but keep one rotation slot for the next iteration. Continuous improvement.

Tag variants explicitly:
- `sms_v1_a` / `sms_v1_b` / `sms_v1_c` for Day 1 variants
- `responded_v1_a` etc. for tracking

Friday Weekly Review pulls these stats. Adjust the standardization quarterly.

---

## Universal SMS principles (apply to everything)

1. **First 8 words = the entire message.** Most people glance at the preview without opening. If those 8 words don't pattern-interrupt or validate, they delete.

2. **Personal name twice.** Once at start, once embedded: "Hi {{first}}, ... {{first}} — let me know..." — feels personal vs blast.
...
- [SOP-CALL-SCRIPTS.md](SOP-CALL-SCRIPTS.md) — phone scripts (need similar V2 rewrite)
